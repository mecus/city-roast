...
var Modules = [
    ...
    __WEBPACK_IMPORTED_MODULE_5__angular_forms__["b" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_16__menu_menu_module__["a" /* MenuModule */], __WEBPACK_IMPORTED_MODULE_25__containers_pages_module__["a" /* PagesModule */],
    __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["d" /* RouterModule */], __WEBPACK_IMPORTED_MODULE_15__authentications_auth_module__["a" /* AuthModule */], __WEBPACK_IMPORTED_MODULE_6__app_routing_module__["a" /* AppRoutingModule */],
...
var AuthService = (function () {
    ...
    AuthService.prototype.getAdminUser = function () {
        ...
        if (uid) {
            this.db.object('accounts/' + uid).valueChanges()
                ...
                if (user) {
                    _this.isAuthenticated = user.isAdmin;
                }
            });
        }
    ...
    AuthService.prototype.updateAccount = function (update) {
        // console.log(this.currentUser["uid"]);
        if (update.uid) {
            var dbRef_1 = this.db.object('accounts/' + update.uid);
            return dbRef_1.update(__assign({}, update, { status: update.status }));
        }
        var dbRef = this.db.object('accounts/' + this.currentUser["uid"]);
    ...
    AuthService.prototype.signInWithFacebook = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_4_firebase_app__["auth"]().signInWithPopup(provider).then(function (result) {
            ...
            // console.log(user);
            // console.log(token);
            var db = __WEBPACK_IMPORTED_MODULE_4_firebase_app__["database"]().ref('accounts/' + user.uid);
            db.once('value').then(function (account) {
                var acc = account.val();
                var dbRef = _this.db.object('accounts/' + user.uid);
                if (!acc) {
                    ...
                    dbRef.update({ status: 'on', lastLogin: Date.now() }).then(function (res) { return console.log(res); }).catch(function (err) { return console.log(err); });
    ...
    LoginComponent.prototype.loginUser = function (user) {
        ...
        if (user) {
            ...
            this.authService.logIn(user)
                ...
                _this.authService.updateAccount(update)
                    .then(function (res) { return console.log("Account Updated Ofter Login"); })
                    .catch(function (err) { return console.log(err); });
...
AboutComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__["d" /* Title */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__["d" /* Title */]) === "function" && _a || Object])
], AboutComponent);
...
var BlogPostComponent = (function () {
    function BlogPostComponent(blogService, route, _router, title) {
    ...
    BlogPostComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (param) {
            _this.blogService.getCacheBlog().subscribe(function (blogs) {
                ...
                _this.blog$ = __WEBPACK_IMPORTED_MODULE_4_lodash__["first"](__WEBPACK_IMPORTED_MODULE_4_lodash__["filter"](blogs, { "key": param["key"] }));
                _this.title.setTitle(_this.blog$.data.title);
...
var BrewingComponent = (function () {
    function BrewingComponent(title) {
        this.title = title;
...
BrewingComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["d" /* Title */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["d" /* Title */]) === "function" && _a || Object])
], BrewingComponent);
...
var ContactsComponent = (function () {
    function ContactsComponent(fb, appService, title) {
        this.fb = fb;
        this.appService = appService;
        this.title = title;
    ...
    NewBlog.prototype.uploadImage = function (selectedFile) {
        ...
        uploadTask.on('state_changed', function (snapshot) {
            ...
            switch (snapshot["state"]) {
                case __WEBPACK_IMPORTED_MODULE_4_firebase__["storage"].TaskState.PAUSED:
                    console.log('Upload is paused');
                    break;
                case __WEBPACK_IMPORTED_MODULE_4_firebase__["storage"].TaskState.RUNNING:
...
var CustomersComponent = (function () {
    ...
    CustomersComponent.prototype.getOnlineUser = function () {
    ...
    CustomersComponent.prototype.getAccounts = function () {
        ...
        this.authService.getAccounts()
            ...
            _this.onlineCustomer = __WEBPACK_IMPORTED_MODULE_2_lodash__["filter"](account, { "status": "on" });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__app_auth_guard_service__ = __webpack_require__("../../../../../src/app/app-auth-guard.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__transaction_transaction_component__ = __webpack_require__("../../../../../src/app/dashboard/transaction/transaction.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var dashRoutes = [
    {
        path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_3__dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__app_auth_guard_service__["a" /* AuthGuard */]],
        children: [
            ...
            { path: 'transactions', component: __WEBPACK_IMPORTED_MODULE_14__transaction_transaction_component__["a" /* TransactionComponent */] }
        ]
    }
];
// canActivate:[AuthGuard]
...
var DashboardComponent = (function () {
    function DashboardComponent(_fb, productService) {
        this._fb = _fb;
        this.productService = productService;
        this.dashBoard = false;
        this.lineForm = _fb.group({
            productName: ["", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required],
            eanNo: ["", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required],
            sku: ["", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required]
        });
    }
    DashboardComponent.prototype.postLineProduct = function (val) {
        var _this = this;
        this.errMsg = "";
    ...
    DashboardComponent.prototype.numberGenerator = function () {
...
// module
exports.push([module.i, "#content, .table-content {\n  min-height: 600px;\n  margin-bottom: 50px; }\n\n.query-button {\n  margin: 0 auto;\n  text-align: center;\n  margin-top: 10px;\n  color: #ffffff; }\n  .query-button a {\n    background-color: lightslategray; }\n  .query-button a#all {\n    background-color: #f27f33; }\n  .query-button a#comp {\n    background-color: #35bbad !important; }\n  .query-button a#pend {\n    background-color: red !important; }\n\ntable tbody td {\n  font-size: 11px; }\n\n.pagination {\n  position: relative;\n  width: 300px;\n  left: 50%;\n  margin-left: -150px;\n  margin-top: 10px; }\n  .pagination pagination-controls {\n    width: 100%; }\n\n.load-item {\n  margin: 0 auto;\n  text-align: center;\n  margin-top: 150px; }\n  .load-item .progress-loading {\n    text-align: center; }\n\n.items button {\n  margin-top: 20px; }\n", ""]);
...
var OrderListComponent = (function () {
    ...
    OrderListComponent.prototype.getCompletedOrders = function () {
        this.orders = __WEBPACK_IMPORTED_MODULE_2_lodash__["filter"](this.queryOrder, { "status": "completed" });
    };
    OrderListComponent.prototype.getPendingOrders = function () {
        this.orders = __WEBPACK_IMPORTED_MODULE_2_lodash__["filter"](this.queryOrder, { "status": "pending" });
    };
    ...
    OrderListComponent.prototype.getAllOrders = function () {
        ...
        this.orderService.getOrdersWithId()
            ...
            _this.orders = __WEBPACK_IMPORTED_MODULE_2_lodash__["reverse"](orders);
            _this.queryOrder = orders;
        });
    };
...
var ProductListComponent = (function () {
    ...
    ProductListComponent.prototype.uploadImage = function () {
        ...
        uploadTask.on('state_changed', function (snapshot) {
            ...
            console.log('Upload is ' + _this.progress + '% done');
            switch (snapshot["state"]) {
                case __WEBPACK_IMPORTED_MODULE_5_firebase__["storage"].TaskState.PAUSED:
                    console.log('Upload is paused');
                    break;
                case __WEBPACK_IMPORTED_MODULE_5_firebase__["storage"].TaskState.RUNNING:
                    console.log('Upload is running');
                    break;
            }
        }, function (error) {
...
var TransactionComponent = (function () {
    ...
    TransactionComponent.prototype.ngOnInit = function () {
        ...
        this.orderService.getTransactions()
            ...
            _this.transactions$ = __WEBPACK_IMPORTED_MODULE_2_lodash__["reverse"](transact);
        });
    };
...
var HomeComponent = (function () {
    function HomeComponent(productService, router, appService, cartService, _fb, blogService, meta, title, mailService) {
        this.productService = productService;
        this.router = router;
        this.appService = appService;
        this.cartService = cartService;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.blogService.getCacheBlog().subscribe(function (blogs) {
            _this.blogs = __WEBPACK_IMPORTED_MODULE_9_lodash__["reverse"](__WEBPACK_IMPORTED_MODULE_9_lodash__["take"](blogs, 3));
        });
    };
...
var MenuComponent = (function () {
    ...
    MenuComponent.prototype.reloadMenu = function () {
    ...
    MenuComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            _this.previlege = _this.authService.isAuthenticated;
            console.log(_this.previlege);
        }, 2000);
        this.cartService.createDb();
        setTimeout(function () {
            _this.cartService.retrieveCart()
...
var AccessoryComponent = (function () {
    function AccessoryComponent(producService, cartService, router, title) {
    ...
    AccessoryComponent.prototype.ngOnInit = function () {
        ...
        this.producService.getProduct()
            ...
            _this.accessory$ = __WEBPACK_IMPORTED_MODULE_5_lodash__["filter"](products, { 'tag': 'accessories' });
        });
    };
...
var CoffeeComponent = (function () {
    function CoffeeComponent(producService, cartService, router, title) {
        this.producService = producService;
        this.cartService = cartService;
        this.router = router;
        this.title = title;
    ...
    CoffeeComponent.prototype.ngOnInit = function () {
        ...
        this.producService.getProduct()
            .subscribe(function (products) {
            _this.coffees$ = __WEBPACK_IMPORTED_MODULE_6_lodash__["filter"](products, { 'tag': 'coffees' });
...
CoffeeComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        animations: [
            Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["j" /* trigger */])('coffeState', [
                Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["g" /* state */])('show', Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["h" /* style */])({
                    display: 'block',
                    transform: 'translateY(0%)',
                    zIndex: 1
                })),
                Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["g" /* state */])('hide', Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["h" /* style */])({
                    display: 'none',
                    zIndex: -1,
                    transform: 'translateY(100%)'
                })),
                Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["i" /* transition */])('show => hide', Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["e" /* animate */])('500ms ease-in')),
                Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["i" /* transition */])('hide => show', Object(__WEBPACK_IMPORTED_MODULE_5__angular_animations__["e" /* animate */])('500ms ease-out'))
            ])
        ]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_product_service__["a" /* ProductService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_product_service__["a" /* ProductService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_check_out_service__["a" /* CheckOutService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_check_out_service__["a" /* CheckOutService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["d" /* Title */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["d" /* Title */]) === "function" && _d || Object])
...
var MachineComponent = (function () {
    function MachineComponent(producService, cartService, router, title) {
        this.producService = producService;
        this.cartService = cartService;
        this.router = router;
        this.title = title;
    ...
    MachineComponent.prototype.ngOnInit = function () {
        ...
        this.producService.getProduct()
            .subscribe(function (products) {
            _this.machines$ = __WEBPACK_IMPORTED_MODULE_5_lodash__["filter"](products, { 'tag': 'machines' });
        });
    };
...
var ProductViewComponent = (function () {
    function ProductViewComponent(productService, route, cartService, router, _location, checkOutService, authService, title) {
        this.productService = productService;
        this.route = route;
        this.cartService = cartService;
        this.router = router;
    ...
    ProductViewComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (param) {
            ...
            _this.productService.getProduct().subscribe(function (products) {
                ...
                _this.title.setTitle(_this.dproduct['name']);
                // console.log(this.dproduct);
                if (_this.dproduct) {
...
OrderSuccessComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_cart_service__["a" /* CartService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_cart_service__["a" /* CartService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["c" /* Meta */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["c" /* Meta */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["d" /* Title */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["d" /* Title */]) === "function" && _d || Object])
...
var CartService = (function () {
    ...
    CartService.prototype.clearCart = function () {
        var transaction = this.db.transaction(["carts"], "readwrite");
        var store = transaction.objectStore("carts");
        var CartDeleteRequest = store.clear();
        CartDeleteRequest.onsuccess = function (e) {
            console.log("Cart Table cleared", e);
        };
        CartDeleteRequest.onerror = function (e) {
            console.log(e);
        };
    };
    return CartService;
...
var MailService = (function () {
    function MailService(_http) {
        ...
        this.welcomeUrl = "http://localhost:5000/welcome"; //"https://londoncityroast.com/welcome";
        this.orderUrl = "https://londoncityroast.com/success_order";
    }
    MailService.prototype.sendWelcomeMail = function (email) {
        var queryData = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpParams */]();
        queryData.set("email", email);
        console.log(queryData);
        return this._http.get("http://localhost:5000/welcome");
    };
    MailService.prototype.sendOrderSuccessMail = function (user) {
...
var OrderService = (function () {
    ...
    OrderService.prototype.getOrdersWithId = function () {
        return this.afDb.list('/orders', function (ref) { return ref.orderByValue(); }).snapshotChanges();
    };
...
var ProductService = (function () {
    ...
    ProductService.prototype.postProductLine = function (line) {
        var dbRef = this.db.list('productline');
        return dbRef.push(line);
    };
    ProductService.prototype.getProductLine = function () {
